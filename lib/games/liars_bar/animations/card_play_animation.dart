...
import 'package:project00/games/liars_bar/widgets/player_layouts/player_slot_positions.dart';
...
class CardPlayAnimation extends StatefulWidget {
  const CardPlayAnimation({
    ...
    this.backCardAsset = 'assets/games/liars_bar/images/cards/white back.png',
    this.playerCount = 5,
...
class CardPlayAnimationState extends State<CardPlayAnimation>
  ...
  Widget _buildAnimatedCard({required Size size, required int cardIndex}) {
    ...
    final curveSide = widget.fromPlayerIndex.isEven ? 1.0 : -1.0;
    final controlPoint =
