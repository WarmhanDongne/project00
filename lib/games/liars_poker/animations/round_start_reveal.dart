...
class _RoundStartRevealState extends State<RoundStartReveal>
  ...
  /// 탑뷰에서 바닥 아래의 작은 물체가 카메라 쪽으로 솟는 깊이감입니다.
  static final Animatable<double> _depthScale = TweenSequence<double>([
    TweenSequenceItem(
      tween: Tween(
        begin: 0.58,
        end: 1.045,
  ...
  static final Animatable<double> _elevation = TweenSequence<double>([
    TweenSequenceItem(
      tween: Tween(
        begin: 0.0,
        end: 1.0,
