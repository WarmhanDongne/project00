...
bool isGamePlayableOnThisBuild(GameInfo game, {required GameCatalog catalog}) {
  final implementation = catalog.find(game.id);
  if (implementation == null) return false;
  if (!GameAssetStore.instance.isGameCompatible(
    game.id,
    requiredAssetVersion: implementation.requiredAssetVersion,
  )) {
    return false;
  }
