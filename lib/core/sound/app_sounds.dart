...
/// `assets/sounds/common/`에 있는 것만 모읍니다.
abstract final class AppSounds {
  /// 게임 진행 중 반복 재생하는 배경음악입니다.
  ///
  /// 효과음이 아니라 BGM 전용 플레이어(`playBgm`)로 재생합니다. 반복 재생이므로
  /// 게임 화면을 떠날 때 반드시 멈춰야 합니다.
  static const background = 'assets/sounds/background/background.mp3';

  /// 카드가 한 장씩 날아갈 때마다 재생하는 짧은 효과음입니다.
  static const dealing = 'assets/sounds/common/dealing.mp3';

  /// 벌칙 결과 도장이 프로필에 찍히는 순간 재생하는 효과음입니다.
  ///
  /// 도장이 내려오기 시작할 때가 아니라 실제로 닿는 순간(진행도 0.30)에
  /// 재생합니다.
  static const stamp = 'assets/sounds/common/stamp.mp3';

  /// 벌칙 룰렛의 레버를 끝까지 내렸을 때 한 번 재생하는 효과음입니다.
  ///
  /// 레버가 실제로 잠기는 순간에만 재생합니다. 임계점에 못 미쳐 손을 뗀 뒤
  /// 레버가 제자리로 돌아가는 경우에는 재생하지 않습니다.
  static const lever = 'assets/sounds/common/lever.mp3';
  ...
  static const roulette = 'assets/sounds/common/roulette.mp3';
}
