...
import 'package:game_contract/games/shared/widgets/critical_network_guard.dart';
import 'package:game_mafia/games/mafia/screens/phone_game.dart';
import 'package:game_mafia/games/mafia/screens/tablet/tablet_role_setup_screen.dart';
import 'package:game_mafia/games/mafia/screens/tablet_game.dart';
...
import 'package:game_kit/games/shared/tablet_preview_artworks.dart';
...
class MafiaGame extends TemplateGame {
  ...
  @override
  Widget buildTabletPreviewArtwork() => MafiaPreviewArtwork(
    roles: [
      Assets.games.mafia.images.cards.roleCitizen.game,
      Assets.games.mafia.images.cards.rolePolice.game,
      Assets.games.mafia.images.cards.roleDoctor.game,
      Assets.games.mafia.images.cards.roleMafia.game,
    ],
    voteBox: Assets.games.mafia.images.other.voteBox.game,
  );
