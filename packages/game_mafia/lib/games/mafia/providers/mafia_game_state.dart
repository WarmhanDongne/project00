...
class MafiaGameState {
  ...
  MafiaGameState copyWith({
    ...
    int? nightActorCount,
    Object? nightStage = _notProvided,
    int? nightStageActorCount,
    int? nightStageSubmittedCount,
    Object? dayEndReason = _notProvided,
    Object? nightActionCue = _notProvided,
    ...
    return MafiaGameState(
      ...
      // nullable 필드는 생략(기존 값 유지)과 명시적 null(서버가 값 제거)을
      // 구분해야 합니다. 일반 copyWith 호출이 진행 상태를 초기화하면 안 됩니다.
      nightStage: identical(nightStage, _notProvided)
          ? this.nightStage
          : nightStage as String?,
      nightStageActorCount: nightStageActorCount ?? this.nightStageActorCount,
      nightStageSubmittedCount:
          nightStageSubmittedCount ?? this.nightStageSubmittedCount,
      dayEndReason: identical(dayEndReason, _notProvided)
          ? this.dayEndReason
          : dayEndReason as String?,
      nightActionCue: identical(nightActionCue, _notProvided)
          ? this.nightActionCue
          : nightActionCue as MafiaNightActionCue?,
