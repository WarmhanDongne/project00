...
class GameReconnectScreen extends StatefulWidget {
  ...
  static const String defaultIllustrationAsset =
      'packages/mosigame_core/assets/images/reconnect/game_controller.webp';

  /// 별 그림 자리입니다. 파일을 넣으면 자동으로 보입니다.
  static const String defaultSparkleAsset =
      'packages/mosigame_core/assets/images/reconnect/star.webp';
