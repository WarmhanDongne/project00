...
class DevErrorEntry {
  ...
  /// 스택에서 앱 또는 workspace package 코드가 처음 나오는 줄입니다.
  ///
  ...
  String? get firstProjectFrame {
    ...
    for (final line in lines) {
      if (_isProjectFrame(line)) return line.trim();
    }
    return null;
  }
}

bool _isProjectFrame(String line) =>
    line.contains('package:project00/') ||
    line.contains('package:mosigame_') ||
    line.contains('package:game_');
