...
import 'package:game_contract/games/shared/player_layouts/player_layout_factory.dart';
...
import 'package:mosigame_platform/platform/home/tablet/widgets/tablet_game_search_bar.dart';
import 'package:mosigame_platform/platform/home/tablet/widgets/tablet_room_panel.dart';
import 'package:mosigame_platform/platform/profile/widgets/tablet_profile.dart';
...
class _TabletHomeState extends State<TabletHome> with WidgetsBindingObserver {
  ...
  Future<void> _openRestoredGameIfReady(String roomCode) async {
    ...
    try {
      // 복구도 자동 다운로드 경로가 아닙니다. 이미 설치된 영구 캐시를 검증한
      // 뒤에만 화면을 열어, 에셋 없는 다운로드 게임의 중간 진입을 막습니다.
